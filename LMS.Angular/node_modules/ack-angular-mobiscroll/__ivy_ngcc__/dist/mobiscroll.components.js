...
MobiscrollCalendar.ɵfac = function MobiscrollCalendar_Factory(t) { return new (t || MobiscrollCalendar)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.MbscProvider)); };
MobiscrollCalendar.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: MobiscrollCalendar, selectors: [["", "mbsc-calendar", ""]], inputs: { mbscOptions: ["mbsc-options", "mbscOptions"], ngModel: "ngModel", mbscCalendar: ["mbsc-calendar", "mbscCalendar"], ref: ["mbsc-calendar-ref", "ref"] }, outputs: { refChange: "mbsc-calendar-refChange", ngModelChange: "ngModelChange", mbscCalendarChange: "mbsc-calendarChange", mbscOptionsChange: "mbsc-optionsChange" }, exportAs: ["mobiscroll"], features: [ɵngcc0.ɵɵNgOnChangesFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MobiscrollCalendar, [{
        type: core_1.Directive,
        args: [{
                selector: '[mbsc-calendar]',
                exportAs: 'mobiscroll'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc1.MbscProvider }]; }, { refChange: [{
            type: core_1.Output,
...
MobiscrollDate.ɵfac = /*@__PURE__*/ function () { var ɵMobiscrollDate_BaseFactory; return function MobiscrollDate_Factory(t) { return (ɵMobiscrollDate_BaseFactory || (ɵMobiscrollDate_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(MobiscrollDate)))(t || MobiscrollDate); }; }();
MobiscrollDate.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: MobiscrollDate, selectors: [["", "mbsc-date", ""]], inputs: { ref: ["mbsc-date-ref", "ref"], mbscCalendar: ["mbsc-date", "mbscCalendar"] }, outputs: { refChange: "mbsc-date-refChange", mbscCalendarChange: "mbsc-dateChange" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MobiscrollDate, [{
        type: core_1.Directive,
        args: [{
                selector: '[mbsc-date]'
            }]
...
MobiscrollDateTime.ɵfac = /*@__PURE__*/ function () { var ɵMobiscrollDateTime_BaseFactory; return function MobiscrollDateTime_Factory(t) { return (ɵMobiscrollDateTime_BaseFactory || (ɵMobiscrollDateTime_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(MobiscrollDateTime)))(t || MobiscrollDateTime); }; }();
MobiscrollDateTime.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: MobiscrollDateTime, selectors: [["", "mbsc-datetime", ""]], inputs: { ref: ["mbsc-datetime-ref", "ref"], mbscCalendar: ["mbsc-datetime", "mbscCalendar"] }, outputs: { refChange: "mbsc-datetime-refChange", mbscCalendarChange: "mbsc-datetimeChange" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MobiscrollDateTime, [{
        type: core_1.Directive,
        args: [{
...
MobiscrollTime.ɵfac = /*@__PURE__*/ function () { var ɵMobiscrollTime_BaseFactory; return function MobiscrollTime_Factory(t) { return (ɵMobiscrollTime_BaseFactory || (ɵMobiscrollTime_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(MobiscrollTime)))(t || MobiscrollTime); }; }();
MobiscrollTime.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: MobiscrollTime, selectors: [["", "mbsc-time", ""]], inputs: { ref: ["mbsc-time-ref", "ref"], mbscCalendar: ["mbsc-time", "mbscCalendar"] }, outputs: { refChange: "mbsc-time-refChange", mbscCalendarChange: "mbsc-timeChange" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MobiscrollTime, [{
        type: core_1.Directive,
        args: [{
                selector: '[mbsc-time]'
            }]
