...
var _a = require('demo-utils'), Logger = _a.Logger, mergeNonLists = _a.mergeNonLists;
var LOGGER = new Logger('pipeline');
exports.isSubset = function (a, b) {
    return a.reduce(function (s, val, key, a) {
        chai_1.assert(val['typeName'], val + " does not have typename");
        var aTypes = Immutable.Set([val.typeName]);
        var bTypes = Immutable.Set([(b.get(key) || types_1.TYPES.badType).typeName]);
        return Boolean(s && (aTypes.isSubset(bTypes) || val(undefined)));
    }, true);
};
var PipeHead = /** @class */ (function () {
    function PipeHead(lastCallables, name) {
        var _this = this;
    ...
    PipeHead.prototype.append = function (newCallables, name) {
        ...
        inputTypes.map(function (v, k) { return chai_1.assert(typeof (v) === 'function', "Invalid type " + v + " for " + k); });
        outputTypes.map(function (v, k) { return chai_1.assert(typeof (v) === 'function', "Invalid type " + v + " for " + k); });
...
var PipeAppended = /** @class */ (function (_super) {
    ...
    function PipeAppended(callables, prev, name) {
        var _this = _super.call(this, callables, name) || this;
        _this.prev = prev;
...
exports.createPipeline = function (pipeline) {
    ...
    var callable = function (initialState) { return __awaiter(void 0, void 0, void 0, function () {
        var inState, pipeSize, _loop_1, _i, _a, pipe;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    inState = initialState;
                    pipeSize = traverseList.size;
                    _loop_1 = function (pipe) {
                        var i, outState, checkedState;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    i = traverseList.indexOf(pipe);
                                    return [4 /*yield*/, pipe.lastCallables.reduce(function (s, v, k, a) { return __awaiter(void 0, void 0, void 0, function () {
                                            var out, prevState, e_1;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        _a.trys.push([0, 3, , 4]);
                                                        return [4 /*yield*/, v(inState)];
                                                    case 1:
                                                        out = _a.sent();
                                                        return [4 /*yield*/, s];
                                                    case 2:
                                                        prevState = _a.sent();
                                                        return [2 /*return*/, mergeNonLists(prevState, out)];
                                                    case 3:
                                                        e_1 = _a.sent();
                                ...
                                case 1:
                                    outState = _a.sent() // start all siblings to merge from same state
                                    ;
                                    checkedState = types_1.checkExtractArgs(outState, pipe.mergedOutputTypes);
