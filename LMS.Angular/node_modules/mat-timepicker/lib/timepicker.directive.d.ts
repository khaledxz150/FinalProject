...
export declare class MatTimepickerDirective implements OnInit, OnChanges, AfterViewInit, OnDestroy, ControlValueAccessor, MatFormFieldControl<any> {
    ...
    handleCancel: () => void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MatTimepickerDirective, [{ optional: true; self: true; }, null, null, null, null, null, null, null, { optional: true; }, { optional: true; }, { optional: true; }, null]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<MatTimepickerDirective, "input[matTimepicker]", ["matTimepicker"], { "okButtonTemplate": "okButtonTemplate"; "cancelButtonTemplate": "cancelButtonTemplate"; "okLabel": "okLabel"; "cancelLabel": "cancelLabel"; "anteMeridiemAbbreviation": "anteMeridiemAbbreviation"; "postMeridiemAbbreviation": "postMeridiemAbbreviation"; "mode": "mode"; "color": "color"; "disableDialogOpenOnClick": "disableDialogOpenOnClick"; "strict": "strict"; "value": "value"; "id": "id"; "errorStateMatcher": "errorStateMatcher"; "disabled": "disabled"; "readonly": "readonly"; "required": "required"; "placeholder": "placeholder"; "minDate": "minDate"; "maxDate": "maxDate"; }, { "timeChange": "timeChange"; "invalidInput": "invalidInput"; }, never>;
}
